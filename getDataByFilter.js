 ...
 *   var _c={"material":"头层牛皮/海绵/聚酯纤维/硬木"};
 ...
 console.log(checkDataByFilter(_d[0],_c));
 console.log(checkDataByFilter(_d[1],_c));
 console.log(checkDataByFilter(_d[2],_c));
 console.log(checkDataByFilter(_d[3],_c));
 */
function checkDataByFilter(/*待识别数据*/data,/*识别条件*/ condition) {
    if(condition[key].constructor==undefined) return ;
    //最终判断结果
    var _result = false;
    //用于定义是否有条件，无条件直接略过
    var _start = true;
